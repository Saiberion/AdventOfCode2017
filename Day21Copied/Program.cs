...
namespace Day21Copied
{
    class Program
    {
        ...
        public static string[] EnhanceStep(string[] grid, ConcurrentDictionary<string, string> rules, int size)
        {
            int newSize = size + 1;
        ...
        public static string[] Enhance(int iterations, string[] grid, ConcurrentDictionary<string, string> rules)
        {
